...
The content of this part is based on **Terence Tao's Analysis II Chapter 7.5 - 8** and **The Bright Side of Mathematics**.
...
{{<aside title="Measurable Function" type="blue">}}
...
{{<aside title="Simple Functions" type="blue">}}
...
{{<aside title="Lebesgue Integral of Simple Functions" type="blue">}}
...
{{<aside title="Lebesgue Integral for Non-negative Functions" type="blue">}}
...
{{<aside title="Absolutely Integrable Functions" type="blue">}}
$ \int_{\Omega} |f| $ is finite and $ f $ measurable.
{{</aside>}}

{{<aside title="Lebesgue Integral for Absolutely Integrable functions" type="blue">}}
$$ \int_{\Omega} := \int_{\Omega} f^+ - \int_{\Omega} f^- $$ where $ f^+ $ is positive part and $ f^- $ is negative part.
{{</aside>}}

## 3.3 Integral Theorems (exchanging operations)
...
## 3.4 Zero or One
{{<aside title="Borel-Cantelli Lemma (not useful at this point)" type="grey">}}
...
{{<aside title="σ-finite" type="blue">}}
...
Given measurable space $ (X, \Sigma, \mu) $ with a measure and $ (Y, \Omega) $ without a measure. If we have a measurable map $ h: X to Y$.

We can measure set $ A \in \Omega $ by the **image / pushforward measure** $ h*\mu(A) = \tilde{\mu}(A) = \mu(h^{-1}(E)) $.
